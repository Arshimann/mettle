...
export const STYLE_DEFS: Record<TrainingStyle, StyleDef> = {
  bodybuilding: {
    ...
    tabs: { split: true, stretch: false, recovery: false, progress: true, learn: true, friends: true },
    preferredRest: 90,
  },
  strength: {
    id: 'strength',
  ...
  crossfit: {
    ...
    tabs: { split: true, stretch: true, recovery: true, progress: true, learn: false, friends: true },
    preferredRest: 60,
  },
  all: {
    id: 'all',
    ...
    icon: Layers,
    recommendedTemplate: 'full-body',
    tabs: { split: true, stretch: true, recovery: false, progress: true, learn: true, friends: true },
    preferredRest: 120,
  },
};
